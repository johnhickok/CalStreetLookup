...
1. Visit the Geofabrik Download Server for California and download 
...
5. Run the Python script below to spatially join OSM roads with USA ZIP Code polygons from Esri (link below). Script extracts data to streetz.csv.
