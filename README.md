...
<p>
It is assumed you already installed and are familiar with <a href="https://qgis.org/en/site/">QGIS</a> (OSGeo4W installation) and <a href="https://postgis.net/">PostGIS</a>. It is also helpful if you have some knowledge of <a href="https://www.gdal.org/">GDAL</a> and <a href="https://www.python.org/">Python</a>. For your convenience, the <a href="https://github.com/johnhickok/CalStreetLookup/wiki">wiki</a> includes some details on how to set up PostGIS for running these scripts.
</p>
<p>
